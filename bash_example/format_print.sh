...
# \033으로 글자색 지정 가능
echo -e "\033[31m소수점 표현\033[0m"
printf "%.4f\n\n" $string

# 괄호를 사용할 땐 따옴표가 필수이다.
echo -e "\033[31m큰 따옴표와 작음 따옴표 차이(escape)\033[0m"
# 작은 따옴표는 \로 escape 문자 처리한다.
printf '작은 따옴표 : \\\n'
# 큰 따옴표는 \\로 escape 문자 처리한다.
printf "큰 따옴표   : \\\n\n\n"

echo -e "\033[31m큰 따옴표와 작은 따옴표 차이(variable)\033[0m"
printf '작은 따옴표 : ${string}\n'
printf "큰 따옴표 : ${string}\n\n"

echo -e "\033[31m%s와 %b의차이\033[0m"
...
echo -e "\033[31m정해진 너비 차지하기\033[0m"
...
echo -e "\033[31m변수로 저장하기\033[0m"
printf -v var "%o" $string
echo "변수 출력 : ${var}\n"

echo -e "\033[31m날짜 출력하기\033[0m"
